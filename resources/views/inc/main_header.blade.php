<header class="{{ backpack_theme_config('classes.header') }}">
    <div class="container-fluid d-flex justify-content-between">
        <button style="margin-inline-start: -14px" class="header-toggler" type="button" onclick="coreui.Sidebar.getInstance(document.querySelector('#sidebar')).toggle()"  aria-label="{{ trans('backpack::base.toggle_navigation')}}">
